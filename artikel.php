                ...
                ?>
                        <div class="py-8 flex flex-wrap md:flex-nowrap">
                            ...
                            <div class="md:flex-grow">
                                <h2 class="text-2xl font-medium text-gray-900 title-font mb-2">Apa itu Heater ?</h2>
                                <p class="leading-relaxed"><?php echo htmlentities($result['deskripsi']); ?></p>
                                <a href="https://id.wikipedia.org/wiki/Pemanas" class="text-indigo-500 inline-flex items-center mt-4">Learn More
