...
if(isset($_POST['submit'])){
	...
	if (mysqli_num_rows($cek) == 0) {
		$sql = mysqli_query($koneksidb, "INSERT INTO testi(id, fotosampul, kota, provinsi, judul, deskripsi) 
		VALUES('$id', '$fotosampul', '$kota', '$provinsi', '$judul', '$deskripsi')") or die(mysqli_error($koneksidb));
