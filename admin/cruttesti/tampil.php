				...
				if (mysqli_num_rows($sql) > 0) {
					...
					while ($data = mysqli_fetch_assoc($sql)) {
						...
						<tr>
							...
							<td>
								<a href="dashboard.php?page=edittesti&id=' . $data['id'] . '" class="btn btn-secondary btn-sm">Ubah</a>
								<a href="cruttesti/delete.php?id='.$data['id'] . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Hapus</a>
							</td>
						</tr>
						';
						$no++;
