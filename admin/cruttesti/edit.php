		...
		<input type="hidden" name="id" value="<?= $_GET['id'] ?>">
		    <div class="item form-group">
				...
				<div class="col-md-6 col-sm-6">
					<input type="file" name="fotosampul" class="form-control" value="<?php echo $data['fotosampul']; ?>" required>
				</div>
			</div>
			<div class="item form-group">
			...
			<div class="item form-group">
				<div class="col-md-6 col-sm-6 offset-md-3">
					...
					<a href="dashboard.php?page=tampiltesti" class="btn btn-warning">Kembali</a>
				</div>
			</div>
		</form>
	</div>
